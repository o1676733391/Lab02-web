<?php
    ...
    if(!empty($action)&& $action=='dangky'){
        ...
        $sothich=filter_input(INPUT_POST,'sothich',FILTER_SANITIZE_FULL_SPECIAL_CHARS,FILTER_REQUIRE_ARRAY);
...
?>
<h3 style="color:red">THÔNG TIN CÁ NHÂN CỦA BẠN ĐÃ ĐĂNG KÝ</h3>
<table width="300">
    <tr>
        <td>Họ và tên</td>
